...
{
    public class GS_RecognizeHuruf : DrawableGameComponent
    {
        ...
        public GS_RecognizeHuruf(Game1 game, SpriteBatch Batch, SpriteFont Font, Texture2D bgImage,
        ...
        {
            recog.setRecognize(objectVector,false);
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (spriteFont != null)
                spriteBatch.DrawString(spriteFont, "     This is a letter = '" + recognizeRes + "'", new Vector2(_boardPosition.X, _boardPosition.Y + (27 * 12) + 50), Color.Black);
            spriteBatch.End();
            #endregion
        }
